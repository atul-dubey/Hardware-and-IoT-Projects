/*********************************************
   ...
   Date: 28/09/2022
   Description:
    This code sends HTTP request on Accelerometer
    angle change and allows you control a robot with
    gestures.
**********************************************/
...
//HTTP end points to control different directions
const char* f = "http://192.168.2.150/movement?state=forward"; //http://192.168.43.175
const char* b = "http://192.168.2.150/movement?state=backward";
const char* l = "http://192.168.2.150/movement?state=left";
const char* r = "http://192.168.2.150/movement?state=right";
const char* s = "http://192.168.2.150/movement?state=stop";

const char* ssid = "WIFI_SSID";          // WiFi credentials of the network.
